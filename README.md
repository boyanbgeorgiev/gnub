...
AI
	След пробване без готов CNN и с ResNet50, решихме, че най-използваем за нас е MobileNetV2. Той е най-ефикасен ос масивните CNN-ове. Т.е. с наличното време и хардуер това е най-добрия вариант за train-ване за нашите цели. Той тренира най-бързо на нашия слаб хардуер и това ни позвои да трнираме dataset-a ни с 200 епохи, нещо което вероятно не би се случило, ако използвахме друга технология.
